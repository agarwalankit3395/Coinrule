            ...
            <Box className='herosbg'>
                <Box sx={{ paddingY: { md: '5rem', xs: '3rem' }, position: 'relative' }}>
                    <Container maxWidth='lg'>
                        <Box sx={{paddingY:{lg:'6rem', md:'4rem', sm:'3rem', xs:'4rem'}, }}>
                            <Typography variant='h3' component="h3" color={"#fff"} fontWeight="500" textAlign="center" gutterBottom sx={{paddingTop:{xs:'3rem', sm:'1rem', md:'0rem', lg:'0rem'}}} paddingBottom={'2rem'}>About Us </Typography>
